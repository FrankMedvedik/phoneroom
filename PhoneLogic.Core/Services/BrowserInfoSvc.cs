...
namespace PhoneLogic.Core.Services
{
    ...
    /// </summary>
    /// <remarks>
    ///     A simple proxy to JavaScript window and screen variables,
    ///     abstracts away common web browser differences
    /// </remarks>
    public static class BrowserInfoSvc
    {
        /// <summary>
        ...
        public static double ClientWidth
        {
            ...
            {
                return _isNavigator
                    ? (double) HtmlPage.Window.GetProperty("innerWidth")
        ...
        public static double ClientHeight
        {
            ...
            {
                return _isNavigator
                    ? (double) HtmlPage.Window.GetProperty("innerHeight")
        ...
        public static double ScrollLeft
        {
            ...
            {
                return _isNavigator
                    ? (double) HtmlPage.Window.GetProperty("pageXOffset")
        ...
        public static double ScrollTop
        {
            ...
            {
                return _isNavigator
                    ? (double) HtmlPage.Window.GetProperty("pageYOffset")
        ...
        {
            get { return (double) Screen.GetProperty("width"); }
        }
        ...
        {
            get { return (double) Screen.GetProperty("height"); }
        }
        ...
        {
            get { return (double) Screen.GetProperty("availWidth"); }
        }
        ...
        {
            get { return (double) Screen.GetProperty("availHeight"); }
        }
        ...
        public static double ScreenPositionLeft
        {
            ...
            {
                return _isNavigator
                    ? (double) HtmlPage.Window.GetProperty("screenX")
        ...
        public static double ScreenPositionTop
        {
            ...
            {
                return _isNavigator
                    ? (double) HtmlPage.Window.GetProperty("screenY")
