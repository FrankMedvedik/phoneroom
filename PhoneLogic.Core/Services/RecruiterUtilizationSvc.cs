...
namespace PhoneLogic.Core.Services
{
    ...
    {
        private static readonly string RecruiterActivityTestData = "";

        private static readonly string RecruiterTimeTestData =
        ...
        public static async Task<List<RecruiterTimeSummary>> GetRecruiterTimeSummaryTest(string Phoneroom,
            ...
            DateTime startDate, DateTime endDate)
        {
            ...
            var data = await client.DownloadStringTaskAsync(
                new Uri(ConditionalConfiguration.apiUrl + "RecruiterTimeSummary?phoneroom=" + phoneroom + "&startDate=" +
                        startDate.Ticks
        ...
        public static async Task<List<RecruiterActivity>> GetRecruiterActivity(string recruiterSIP, DateTime startDate,
            DateTime endDate)
        {
